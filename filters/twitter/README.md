This package provides a [jargon](https://github.com/clipperhouse/jargon) filter to identify Twitter-style hanshtags and handles, combining them into a single token.
